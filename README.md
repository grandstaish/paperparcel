...
```groovy
dependencies {
  compile 'nz.bradcampbell:paperparcel:2.0.3'
  annotationProcessor 'nz.bradcampbell:paperparcel-compiler:2.0.3'
}
```
...
dependencies {
  compile 'nz.bradcampbell:paperparcel:2.0.3'
  compile 'nz.bradcampbell:paperparcel-kotlin:2.0.3' // Optional
  kapt 'nz.bradcampbell:paperparcel-compiler:2.0.3'
}
```
