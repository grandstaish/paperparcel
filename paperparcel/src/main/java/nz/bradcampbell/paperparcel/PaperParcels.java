...
/**
 * Central mechanism for {@link #wrap(Object)}ing/{@link #unwrap(Parcelable)}ping PaperParcel objects.
 */
public final class PaperParcels {
  ...
  public static <T> T unwrap(Parcelable parcelable) {
    ...
    if (parcelable instanceof TypedParcelable) {
      ...
      throw new IllegalArgumentException(parcelable.getClass().getName() + " is not recognised by PaperParcel");
    }
    //noinspection unchecked
