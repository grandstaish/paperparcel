...
public class EnumProperty extends Property {
  public EnumProperty(boolean isNullable, TypeName typeName, boolean isInterface, String name,
  ...
  protected CodeBlock readFromParcelInner(CodeBlock.Builder block, ParameterSpec in, @Nullable FieldSpec classLoader,
    ...
    return CodeBlock.of("$T.valueOf($T.class, $N.readString())", Enum.class, getTypeName(), in);
  }
  ...
  protected void writeToParcelInner(
      ...
      Map<ClassName, CodeBlock> typeAdaptersMap, Set<String> scopedVariableNames) {
    block.addStatement("$N.writeString($L.name())", dest, sourceLiteral);
  }
}
