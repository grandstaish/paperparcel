...
public class SerializableProperty extends Property {
  public SerializableProperty(boolean isNullable, TypeName typeName, boolean isInterface, String name,
  ...
  protected CodeBlock readFromParcelInner(CodeBlock.Builder block, ParameterSpec in, @Nullable FieldSpec classLoader,
    ...
    return CodeBlock.of("($T) $N.readSerializable()", getTypeName(), in);
  }
