...
public class StringArrayTests {
  ...
  @Test public void stringArrayTest() throws Exception {
    ...
    JavaFileObject expectedSource = JavaFileObjects.forSourceString("test/TestParcel",
        Joiner.on('\n')
            .join("package test;", "import android.os.Parcel;", "import android.os.Parcelable;",
                ...
                "outChild = in.createStringArray();", "}", "Test data = new Test(outChild);",
                ...
                "String[] child = this.data.getChild();", "if (child == null) {",
