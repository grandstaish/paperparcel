  ...
  @Test public void wildcardTypeTest() throws Exception {
    JavaFileObject source = JavaFileObjects.forSourceString("test.Test", Joiner.on('\n')
        .join("package test;", "import nz.bradcampbell.paperparcel.PaperParcel;",
            ...
            "public Test(List<List<? extends Integer>> child) {", "this.child = child;", "}",
            "public List<List<? extends Integer>> getChild() {", "return this.child;", "}", "}"));
    ...
    JavaFileObject expectedSource = JavaFileObjects.forSourceString("test/TestParcel",
        Joiner.on('\n')
            .join("package test;", "import android.os.Parcel;", "import android.os.Parcelable;",
                ...
                "List<List<? extends Integer>> outChild = null;", "if (in.readInt() == 0) {",
                ...
                "List<? extends Integer> outChildItem = null;", "if (in.readInt() == 0) {",
                ...
                "Integer outChildItemItem = null;", "if (in.readInt() == 0) {",
                "outChildItemItem = in.readInt();", "}", "childItem.add(outChildItemItem);", "}",
                ...
                "if (child == null) {", "dest.writeInt(1);", "} else {", "dest.writeInt(0);",
                ...
                "if (childItemItem == null) {", "dest.writeInt(1);", "} else {",
                "dest.writeInt(0);", "dest.writeInt(childItemItem);", "}", "}", "}", "}", "}",
                "}"));
