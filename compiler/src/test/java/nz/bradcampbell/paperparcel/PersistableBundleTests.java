...
public class PersistableBundleTests {
  ...
  @Test public void persistableBundleTest() throws Exception {
    JavaFileObject source = JavaFileObjects.forSourceString("test.Test", Joiner.on('\n')
        .join("package test;", "import android.os.PersistableBundle;",
            "import nz.bradcampbell.paperparcel.PaperParcel;", "@PaperParcel",
            "public final class Test {", "private final PersistableBundle child;",
            "public Test(PersistableBundle child) {", "this.child = child;", "}",
            "public PersistableBundle getChild() {", "return this.child;", "}", "}"));
    ...
    JavaFileObject expectedSource = JavaFileObjects.forSourceString("test/TestParcel",
        Joiner.on('\n')
            .join("package test;", "import android.os.Parcel;", "import android.os.Parcelable;",
                "import android.os.PersistableBundle;", "import java.lang.ClassLoader;",
                ...
                "PersistableBundle outChild = null;", "if (in.readInt() == 0) {",
                ...
                "PersistableBundle child = this.data.getChild();", "if (child == null) {",
