...
public class IBinderTests {
  ...
  @Test public void binderTest() throws Exception {
    JavaFileObject source = JavaFileObjects.forSourceString("test.Test", Joiner.on('\n')
        .join("package test;", "import android.os.IBinder;",
            "import nz.bradcampbell.paperparcel.PaperParcel;", "@PaperParcel",
            "public final class Test {", "private final IBinder child;",
            "public Test(IBinder child) {", "this.child = child;", "}",
            "public IBinder getChild() {", "return this.child;", "}", "}"));

    JavaFileObject expectedSource = JavaFileObjects.forSourceString("test/TestParcel",
        Joiner.on('\n')
            .join("package test;", "import android.os.IBinder;", "import android.os.Parcel;",
                ...
                "IBinder outChild = null;", "if (in.readInt() == 0) {",
                "outChild = in.readStrongBinder();", "}", "Test data = new Test(outChild);",
                ...
                "IBinder child = this.data.getChild();", "if (child == null) {",
