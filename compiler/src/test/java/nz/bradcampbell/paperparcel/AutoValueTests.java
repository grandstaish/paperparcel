...
public class AutoValueTests {
  @Test public void basicAutoValueTest() throws Exception {
    JavaFileObject source = JavaFileObjects.forSourceString("test.Test", Joiner.on('\n')
        .join("package test;", "import com.google.auto.value.AutoValue;",
            "import android.os.Parcelable;", "import java.util.Date;", "@AutoValue",
            "public abstract class Test implements Parcelable {", "public abstract int count();",
            "}"));

    JavaFileObject autoValueSubclass = JavaFileObjects.forSourceString("test/AutoValue_Test", Joiner
        .on('\n')
        .join("package test;", "import android.os.Parcel;", "import android.os.Parcelable;",
            "import java.lang.ClassLoader;", "import java.lang.Override;",
            "import nz.bradcampbell.paperparcel.PaperParcel;",
            "import nz.bradcampbell.paperparcel.PaperParcels;", "@PaperParcel",
            ...
            "return new AutoValue_Test[size];", "}", "};", "AutoValue_Test(int count) {",
            "super(count);", "}", "@Override",
            "public void writeToParcel(Parcel dest, int flags) {",
            "dest.writeParcelable(PaperParcels.wrap(this), flags);", "}", "@Override",
            "public int describeContents() {", "return 0;", "}", "}"));

    JavaFileObject wrapperSource = JavaFileObjects.forSourceString("test/AutoValue_TestParcel",
        Joiner.on('\n')
            .join("package test;", "import android.os.Parcel;", "import android.os.Parcelable;",
                ...
                "int count = in.readInt();", "AutoValue_Test data = new AutoValue_Test(count);",
                ...
                "public AutoValue_TestParcel(AutoValue_Test data) {", "this.data = data;", "}",
                "@Override public AutoValue_Test get() {", "return this.data;", "}",
    ...
    JavaFileObject wrapperSource = JavaFileObjects.forSourceString("test/AutoValue_TestParcel",
        Joiner.on('\n')
            .join("package test;", "import android.os.Parcel;", "import android.os.Parcelable;",
                ...
                "private final AutoValue_Test data;",
                "public AutoValue_TestParcel(AutoValue_Test data) {", "this.data = data;", "}",
                "@Override public AutoValue_Test get() {", "return this.data;", "}", "@Override",
  ...
  @Test public void failWhenWriteToParcelAlreadyDefinedTest() throws Exception {
    JavaFileObject source = JavaFileObjects.forSourceString("test.Test", Joiner.on('\n')
        .join("package test;", "import com.google.auto.value.AutoValue;",
            "import android.os.Parcel;", "import android.os.Parcelable;", "import java.util.Date;",
            "@AutoValue", "public abstract class Test implements Parcelable {",
            "public abstract int count();", "@Override",
            "public void writeToParcel(Parcel dest, int flags) {", "}", "}"));
    ...
    assertAbout(javaSource()).that(source)
        ...
        .failsToCompile()
        .withErrorContaining(
            "Manual implementation of Parcelable#writeToParcel(Parcel,int) found when "
  ...
  @Test public void failWhenCreatorAlreadyDefinedTest() throws Exception {
    JavaFileObject source = JavaFileObjects.forSourceString("test.Test", Joiner.on('\n')
        .join("package test;", "import com.google.auto.value.AutoValue;",
            ...
            "@Override public Test createFromParcel(Parcel in) {", "return null;", "}",
    ...
    assertAbout(javaSource()).that(source)
        ...
        .failsToCompile()
        .withErrorContaining(
            "Manual implementation of a static Parcelable.Creator<T> CREATOR field found "
