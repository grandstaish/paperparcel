...
public class AutoValueTests {
  ...
  @Test public void basicAutoValueTest() throws Exception {
    ...
    JavaFileObject wrapperSource =
        JavaFileObjects.forSourceString("test/AutoValue_TestParcel", Joiner.on('\n').join(
            "package test;",
            "import android.os.Parcel;",
            "import android.os.Parcelable;",
            "import java.lang.Override;",
            ...
            "  public static final Parcelable.Creator<AutoValue_TestParcel> CREATOR = ",
            "      new Parcelable.Creator<AutoValue_TestParcel>() {",
