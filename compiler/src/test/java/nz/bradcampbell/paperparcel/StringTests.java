  ...
  @Test public void stringTest() throws Exception {
    JavaFileObject source = JavaFileObjects.forSourceString("test.Test", Joiner.on('\n')
        .join("package test;", "import nz.bradcampbell.paperparcel.PaperParcel;", "@PaperParcel",
            ...
            "public Test(String child) {", "this.child = child;", "}", "public String getChild() {",
            "return this.child;", "}", "}"));
    ...
    JavaFileObject expectedSource = JavaFileObjects.forSourceString("test/TestParcel",
        Joiner.on('\n')
            .join("package test;", "import android.os.Parcel;", "import android.os.Parcelable;",
                ...
                "String outChild = null;", "if (in.readInt() == 0) {",
                "outChild = in.readString();", "}", "Test data = new Test(outChild);",
                ...
                "String child = this.data.getChild();", "if (child == null) {", "dest.writeInt(1);",
                "} else {", "dest.writeInt(0);", "dest.writeString(child);", "}", "}", "}"));
