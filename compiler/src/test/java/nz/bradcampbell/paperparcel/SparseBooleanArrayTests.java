...
public class SparseBooleanArrayTests {
  ...
  @Test public void sparseBooleanArrayTest() throws Exception {
    JavaFileObject source = JavaFileObjects.forSourceString("test.Test", Joiner.on('\n')
        .join("package test;", "import android.util.SparseBooleanArray;",
            "import nz.bradcampbell.paperparcel.PaperParcel;", "@PaperParcel",
            "public final class Test {", "private final SparseBooleanArray child;",
            "public Test(SparseBooleanArray child) {", "this.child = child;", "}",
            "public SparseBooleanArray getChild() {", "return this.child;", "}", "}"));
    ...
    JavaFileObject expectedSource = JavaFileObjects.forSourceString("test/TestParcel",
        Joiner.on('\n')
            .join("package test;", "import android.os.Parcel;", "import android.os.Parcelable;",
                "import android.util.SparseBooleanArray;", "import java.lang.Override;",
                "import nz.bradcampbell.paperparcel.TypedParcelable;",
                "public final class TestParcel implements TypedParcelable<Test> {",
                "public static final Parcelable.Creator<TestParcel> CREATOR = new Parcelable.Creator<TestParcel>() {",
                "@Override public TestParcel createFromParcel(Parcel in) {",
                "SparseBooleanArray outChild = null;", "if (in.readInt() == 0) {",
                "outChild = in.readSparseBooleanArray();", "}", "Test data = new Test(outChild);",
                ...
                "SparseBooleanArray child = this.data.getChild();", "if (child == null) {",
