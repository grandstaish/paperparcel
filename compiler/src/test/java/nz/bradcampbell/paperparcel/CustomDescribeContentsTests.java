...
public class CustomDescribeContentsTests {

  @Test public void customDescribeContentsTest() throws Exception {
    JavaFileObject source = JavaFileObjects.forSourceString("test.Test", Joiner.on('\n').join(
        "package test;",
        "import android.os.Parcelable;",
        "import nz.bradcampbell.paperparcel.PaperParcel;",
        "@PaperParcel(describeContents = Parcelable.PARCELABLE_WRITE_RETURN_VALUE)",
