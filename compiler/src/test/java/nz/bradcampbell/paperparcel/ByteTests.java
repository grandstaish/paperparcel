...
public class ByteTests {
  ...
  @Test public void primitiveByteTest() throws Exception {
    JavaFileObject source = JavaFileObjects.forSourceString("test.Test", Joiner.on('\n')
        .join("package test;", "import nz.bradcampbell.paperparcel.PaperParcel;", "@PaperParcel",
            "public final class Test {", "private final byte child;", "public Test(byte child) {",
            "this.child = child;", "}", "public byte getChild() {", "return this.child;", "}",
            "}"));
    ...
    JavaFileObject expectedSource = JavaFileObjects.forSourceString("test/TestParcel",
        Joiner.on('\n')
            .join("package test;", "import android.os.Parcel;", "import android.os.Parcelable;",
                ...
                "byte child = in.readByte();", "Test data = new Test(child);",
                ...
                "byte child = this.data.getChild();", "dest.writeByte(child);", "}", "}"));
  ...
  @Test public void boxedByteTest() throws Exception {
    JavaFileObject source = JavaFileObjects.forSourceString("test.Test", Joiner.on('\n')
        .join("package test;", "import nz.bradcampbell.paperparcel.PaperParcel;", "@PaperParcel",
            "public final class Test {", "private final Byte child;", "public Test(Byte child) {",
            "this.child = child;", "}", "public Byte getChild() {", "return this.child;", "}",
    ...
    JavaFileObject expectedSource = JavaFileObjects.forSourceString("test/TestParcel",
        Joiner.on('\n')
            .join("package test;", "import android.os.Parcel;", "import android.os.Parcelable;",
                "import java.lang.Byte;", "import java.lang.Override;",
                "import nz.bradcampbell.paperparcel.TypedParcelable;",
                "public final class TestParcel implements TypedParcelable<Test> {",
                "public static final Parcelable.Creator<TestParcel> CREATOR = new Parcelable.Creator<TestParcel>() {",
                "@Override public TestParcel createFromParcel(Parcel in) {",
                "Byte outChild = null;", "if (in.readInt() == 0) {", "outChild = in.readByte();",
                ...
                "} else {", "dest.writeInt(0);", "dest.writeByte(child);", "}", "}", "}"));
