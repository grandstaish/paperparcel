...
public class ListTests {
  ...
  @Test public void nullableListOfParcelableTypesTest() throws Exception {
    JavaFileObject source = JavaFileObjects.forSourceString("test.Test", Joiner.on('\n').join(
        ...
        "@Nullable private final List<Integer> child;",
        "public Test(@Nullable List<Integer> child) {",
        "this.child = child;",
        "}",
        "@Nullable public List<Integer> getChild() {",
        "return this.child;",
        "}",
        "}"
    ));
  ...
  @Test public void nullableListOfNonParcelableTypesTest() throws Exception {
    JavaFileObject dataClassRoot = JavaFileObjects.forSourceString("test.Root", Joiner.on('\n').join(
        ...
        "this.child = child;",
        "}",
        "@Nullable public List<Child> getChild() {",
        "return this.child;",
        "}",
        "}"
    ));
  ...
  @Test public void listOfParcelableMapsTest() throws Exception {
    ...
    JavaFileObject expectedSource = JavaFileObjects.forSourceString("test/TestParcel", Joiner.on('\n').join(
        ...
        "for (int childItemIndex = 0; childItemIndex < childItemSize; childItemIndex++) {",
        "Integer childItemKey = (Integer) in.readValue(null);",
        "Integer childItemValue = (Integer) in.readValue(null);",
        "childItem.put(childItemKey, childItemValue);",
        "}",
        "outChildItem = childItem;",
        "}",
        "child.add(outChildItem);",
        ...
        "dest.writeValue(childParamEntry.getKey());",
        "dest.writeValue(childParamEntry.getValue());",
        "}",
        "}",
        "}",
        "}",
  ...
  @Test public void listOfNonParcelableMapsTest() throws Exception {
    ...
    JavaFileObject rootParcel = JavaFileObjects.forSourceString("test/RootParcel", Joiner.on('\n').join(
        ...
        "}",
        "childItem.put(childItemKey, outChildItemValue);",
        "}",
        "outChildItem = childItem;",
        "}",
        "child.add(outChildItem);",
