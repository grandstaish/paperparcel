...
public class StringArrayProperty extends Property {
  public StringArrayProperty(boolean isNullable, String name, VariableElement variableElement) {
  ...
  @Override protected void writeToParcelInner(CodeBlock.Builder block, ParameterSpec dest) {
    block.add("$N.writeStringArray($N.$N())", dest, DATA_VARIABLE_NAME, getGetterMethodName());
  }
}
