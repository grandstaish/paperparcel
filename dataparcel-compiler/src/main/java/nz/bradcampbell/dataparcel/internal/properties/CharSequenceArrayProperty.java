...
public class CharSequenceArrayProperty extends Property {
  public CharSequenceArrayProperty(boolean isNullable, String name, VariableElement variableElement) {
  ...
  @Override protected void writeToParcelInner(CodeBlock.Builder block, ParameterSpec dest) {
    block.add("$N.writeCharSequenceArray($N.$N())", dest, DATA_VARIABLE_NAME, getGetterMethodName());
  }
}
