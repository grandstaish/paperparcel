...
public class ValueTests {
  ...
  @Test public void nullableTest() throws Exception {
    ...
    JavaFileObject expectedSource = JavaFileObjects.forSourceString("test/TestParcel", Joiner.on('\n').join(
        ...
        "component1 = (Boolean) in.readValue(Boolean.class.getClassLoader());",
  ...
  @Test public void byteTest() throws Exception {
    ...
    JavaFileObject expectedSource = JavaFileObjects.forSourceString("test/TestParcel", Joiner.on('\n').join(
        ...
        "component1 = (Byte) in.readValue(Byte.class.getClassLoader());",
        "this.data = new Test(component1);",
        "}",
        "public static final TestParcel wrap(Test data) {",
        "return new TestParcel(data);",
  ...
  @Test public void charTest() throws Exception {
    ...
    JavaFileObject expectedSource = JavaFileObjects.forSourceString("test/TestParcel", Joiner.on('\n').join(
        ...
        "component1 = (Character) in.readValue(Character.class.getClassLoader());",
        "this.data = new Test(component1);",
        "}",
        "public static final TestParcel wrap(Test data) {",
        "return new TestParcel(data);",
  ...
  @Test public void doubleTest() throws Exception {
    ...
    JavaFileObject expectedSource = JavaFileObjects.forSourceString("test/TestParcel", Joiner.on('\n').join(
        ...
        "}",
        "private TestParcel(Parcel in) {",
        "Double component1 = null;",
        "component1 = (Double) in.readValue(Double.class.getClassLoader());",
        "this.data = new Test(component1);",
        "}",
        "public static final TestParcel wrap(Test data) {",
        "return new TestParcel(data);",
  ...
  @Test public void floatTest() throws Exception {
    ...
    JavaFileObject expectedSource = JavaFileObjects.forSourceString("test/TestParcel", Joiner.on('\n').join(
        ...
        "}",
        "private TestParcel(Parcel in) {",
        "Float component1 = null;",
        "component1 = (Float) in.readValue(Float.class.getClassLoader());",
        "this.data = new Test(component1);",
        "}",
        "public static final TestParcel wrap(Test data) {",
        "return new TestParcel(data);",
