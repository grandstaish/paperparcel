...
public class ArrayTests {
  ...
  @Test public void genericNonParcelableArrayTest() {
    ...
    JavaFileObject expectedSource1 = JavaFileObjects.forSourceString("test/TestParcel", Joiner.on('\n').join(
        ...
        "}",
        "private TestParcel(Parcel in) {",
        "ChildChildIntegerLongBooleanParcel component1Parcel = ChildChildIntegerLongBooleanParcel.CREATOR.createFromParcel(in);",
        ...
        "ChildChildIntegerLongBooleanParcel component1Parcel = ChildChildIntegerLongBooleanParcel.wrap(component1);",
        "component1Parcel.writeToParcel(dest, 0);",
        "}",
        "}"
    ));

    JavaFileObject expectedSource2 = JavaFileObjects.forSourceString("test/ChildChildIntegerLongBooleanParcel", Joiner.on('\n').join(
        "package test;",
        "import android.os.Parcel;",
        "import android.os.Parcelable;",
        "import java.lang.Boolean;",
        ...
        "import java.lang.Long;",
        "import java.lang.Override;",
        "public class ChildChildIntegerLongBooleanParcel implements Parcelable {",
        "public static final Parcelable.Creator<ChildChildIntegerLongBooleanParcel> CREATOR = new Parcelable.Creator<ChildChildIntegerLongBooleanParcel>() {",
        "@Override public ChildChildIntegerLongBooleanParcel createFromParcel(Parcel in) {",
        "return new ChildChildIntegerLongBooleanParcel(in);",
        "}",
        "@Override public ChildChildIntegerLongBooleanParcel[] newArray(int size) {",
        "return new ChildChildIntegerLongBooleanParcel[size];",
        "}",
        "};",
        "private final Child<Child<Integer, Long>, Boolean> data;",
        "private ChildChildIntegerLongBooleanParcel(Child<Child<Integer, Long>, Boolean> data) {",
        "this.data = data;",
        "}",
        "private ChildChildIntegerLongBooleanParcel(Parcel in) {",
        "ChildIntegerLongParcel component1Parcel = ChildIntegerLongParcel.CREATOR.createFromParcel(in);",
        ...
        "}",
        "public static final ChildChildIntegerLongBooleanParcel wrap(Child<Child<Integer, Long>, Boolean> data) {",
        "return new ChildChildIntegerLongBooleanParcel(data);",
        "}",
        ...
        "ChildIntegerLongParcel component1Parcel = ChildIntegerLongParcel.wrap(component1);",
        "component1Parcel.writeToParcel(dest, 0);",
    ...
    JavaFileObject expectedSource3 = JavaFileObjects.forSourceString("test/ChildIntegerLongParcel", Joiner.on('\n').join(
        "package test;",
        "import android.os.Parcel;",
        "import android.os.Parcelable;",
        "import java.lang.Integer;",
        "import java.lang.Long;",
        "import java.lang.Override;",
        "public class ChildIntegerLongParcel implements Parcelable {",
        "public static final Parcelable.Creator<ChildIntegerLongParcel> CREATOR = new Parcelable.Creator<ChildIntegerLongParcel>() {",
        "@Override public ChildIntegerLongParcel createFromParcel(Parcel in) {",
        "return new ChildIntegerLongParcel(in);",
        "}",
        "@Override public ChildIntegerLongParcel[] newArray(int size) {",
        "return new ChildIntegerLongParcel[size];",
        "}",
        "};",
        "private final Child<Integer, Long> data;",
        "private ChildIntegerLongParcel(Child<Integer, Long> data) {",
        "this.data = data;",
        "}",
        "private ChildIntegerLongParcel(Parcel in) {",
        ...
        "}",
        "public static final ChildIntegerLongParcel wrap(Child<Integer, Long> data) {",
        "return new ChildIntegerLongParcel(data);",
        "}",
