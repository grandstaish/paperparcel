...
public class DoublePropertyTests {
  ...
  @Test public void nullableDoubleTest() throws Exception {
    JavaFileObject source = JavaFileObjects.forSourceString("test.Test", Joiner.on('\n').join(
        ...
        "@Nullable private final Double child;",
        "public Test(@Nullable Double child) {",
        "this.child = child;",
        "}",
        "@Nullable public Double component1() {",
        "return this.child;",
        "}",
        "}"
    ));
