...
public class StringTests {
  ...
  @Test public void nullableStringTest() throws Exception {
    JavaFileObject source = JavaFileObjects.forSourceString("test.Test", Joiner.on('\n').join(
        ...
        "public Test(@Nullable String testString) {",
        "this.testString = testString;",
        "}",
        "@Nullable public String component1() {",
    ...
    JavaFileObject expectedSource = JavaFileObjects.forSourceString("test/TestParcel", Joiner.on('\n').join(
        ...
        "String outComponent1 = null;",
        "if (in.readInt() == 0) {",
        "outComponent1 = in.readString();",
        "}",
  ...
  @Test public void stringTest() throws Exception {
    ...
    JavaFileObject expectedSource = JavaFileObjects.forSourceString("test/TestParcel", Joiner.on('\n').join(
        ...
        "}",
        "private TestParcel(Parcel in) {",
        "String component1 = in.readString();",
