...
public class EnumTests {
  ...
  @Test public void nullableEnumTest() throws Exception {
    JavaFileObject source = JavaFileObjects.forSourceString("test.Test", Joiner.on('\n').join(
        ...
        "@Nullable private final TestEnum testEnum;",
        "public Test(@Nullable TestEnum testEnum) {",
        "this.testEnum = testEnum;",
        "}",
        "enum TestEnum {",
        "ONE;",
        "}",
        "@Nullable public TestEnum component1() {",
    ...
    JavaFileObject expectedSource = JavaFileObjects.forSourceString("test/TestParcel", Joiner.on('\n').join(
        ...
        "Test.TestEnum outComponent1 = null;",
        "if (in.readInt() == 0) {",
        "outComponent1 = (Test.TestEnum) in.readSerializable();",
        "}",
