...
public class MapTests {
  ...
  @Test public void nullableMapOfParcelableTypesTest() throws Exception {
    ...
    JavaFileObject testParcel = JavaFileObjects.forSourceString("test/TestParcel", Joiner.on('\n').join(
        ...
        "if (in.readInt() == 0) {",
        "component1 = (Map<Integer, Integer>) in.readHashMap(Integer.class.getClassLoader());",
        "}",
  ...
  @Test public void mapWithDataTypeAsKeyTest() throws Exception {
    ...
    JavaFileObject rootParcel = JavaFileObjects.forSourceString("test/RootParcel", Joiner.on('\n').join(
        ...
        "Map<ChildParcel, Integer> component1Wrapped = (Map<ChildParcel, Integer>) in.readHashMap(Integer.class.getClassLoader());",
        "component1 = new HashMap<Child, Integer>(component1Wrapped.size());",
        ...
        "Map<ChildParcel, Integer> component1Wrapped = new HashMap<ChildParcel, Integer>(component1.size());",
  ...
  @Test public void mapWithDataTypeAsValueTest() throws Exception {
    ...
    JavaFileObject rootParcel = JavaFileObjects.forSourceString("test/RootParcel", Joiner.on('\n').join(
        ...
        "Map<Integer, ChildParcel> component1Wrapped = (Map<Integer, ChildParcel>) in.readHashMap(ChildParcel.class.getClassLoader());",
        "component1 = new HashMap<Integer, Child>(component1Wrapped.size());",
        ...
        "Map<Integer, ChildParcel> component1Wrapped = new HashMap<Integer, ChildParcel>(component1.size());",
  ...
  @Test public void mapWithDataTypeAsKeyAndValueTest() throws Exception {
    ...
    JavaFileObject rootParcel = JavaFileObjects.forSourceString("test/RootParcel", Joiner.on('\n').join(
        ...
        "Map<ChildParcel, ChildParcel> component1Wrapped = (Map<ChildParcel, ChildParcel>) in.readHashMap(ChildParcel.class.getClassLoader());",
        "component1 = new HashMap<Child, Child>(component1Wrapped.size());",
        "for (ChildParcel _component1Wrapped : component1Wrapped.keySet()) {",
        "Child _component1 = null;",
        "_component1 = _component1Wrapped.getContents();",
        "ChildParcel $component1Wrapped = component1Wrapped.get(_component1Wrapped);",
        ...
        "Map<ChildParcel, ChildParcel> component1Wrapped = new HashMap<ChildParcel, ChildParcel>(component1.size());",
        "for (Child component1Item : component1.keySet()) {",
        "ChildParcel _component1 = ChildParcel.wrap(component1Item);",
        "ChildParcel $component1 = ChildParcel.wrap(component1.get(component1Item));",
        "component1Wrapped.put(_component1, $component1);",
  ...
  @Test public void mapWithParcelableListAsValueTest() throws Exception {
    ...
    JavaFileObject rootParcel = JavaFileObjects.forSourceString("test/RootParcel", Joiner.on('\n').join(
        ...
        "component1 = (Map<Integer, List<Integer>>) in.readHashMap(List.class.getClassLoader());",
        "this.data = new Root(component1);",
        "}",
        "public static final RootParcel wrap(Root data) {",
        "return new RootParcel(data);",
  ...
  @Test public void mapWithNonParcelableListAsValueTest() throws Exception {
    ...
    JavaFileObject rootParcel = JavaFileObjects.forSourceString("test/RootParcel", Joiner.on('\n').join(
        ...
        "Map<Integer, List<ChildParcel>> component1Wrapped = (Map<Integer, List<ChildParcel>>) in.readHashMap(List.class.getClassLoader());",
        "component1 = new HashMap<Integer, List<Child>>(component1Wrapped.size());",
        "for (Integer _component1Wrapped : component1Wrapped.keySet()) {",
        "Integer _component1 = null;",
        "_component1 = _component1Wrapped;",
        ...
        "Map<Integer, List<ChildParcel>> component1Wrapped = new HashMap<Integer, List<ChildParcel>>(component1.size());",
        "for (Integer component1Item : component1.keySet()) {",
        "Integer _component1 = component1Item;",
  ...
  @Test public void mapWithParcelableListAsKeyAndNonParcelableListAsValueTest() throws Exception {
    ...
    JavaFileObject rootParcel = JavaFileObjects.forSourceString("test/RootParcel", Joiner.on('\n').join(
        ...
        "}",
        "private RootParcel(Parcel in) {",
        "Map<List<Integer>, List<Child>> component1 = null;",
        "Map<List<Integer>, List<ChildParcel>> component1Wrapped = (Map<List<Integer>, List<ChildParcel>>) in.readHashMap(List.class.getClassLoader());",
        "component1 = new HashMap<List<Integer>, List<Child>>(component1Wrapped.size());",
        "for (List<Integer> _component1Wrapped : component1Wrapped.keySet()) {",
        "List<Integer> _component1 = null;",
        "_component1 = _component1Wrapped;",
        "List<ChildParcel> $component1Wrapped = component1Wrapped.get(_component1Wrapped);",
        "List<Child> $component1 = null;",
        "$component1 = new ArrayList<Child>($component1Wrapped.size());",
        ...
        "Map<List<Integer>, List<ChildParcel>> component1Wrapped = new HashMap<List<Integer>, List<ChildParcel>>(component1.size());",
        "for (List<Integer> component1Item : component1.keySet()) {",
        "List<Integer> _component1 = component1Item;",
        "List<Child> $component1 = component1.get(component1Item);",
        "List<ChildParcel> $component1Wrapped = new ArrayList<ChildParcel>($component1.size());",
        "for (Child $component1Item : $component1) {",
        "ChildParcel _$component1 = ChildParcel.wrap($component1Item);",
  ...
  @Test public void treeMapOfParcelableTypesTest() throws Exception {
    ...
    JavaFileObject testParcel = JavaFileObjects.forSourceString("test/TestParcel", Joiner.on('\n').join(
        ...
        "in.readMap(component1, Integer.class.getClassLoader());",
        "this.data = new Test(component1);",
        "}",
        "public static final TestParcel wrap(Test data) {",
        "return new TestParcel(data);",
