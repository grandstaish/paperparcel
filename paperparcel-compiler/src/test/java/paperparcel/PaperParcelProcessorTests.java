  ...
  @Test public void allBuiltInAdaptersTest() {
    ...
    JavaFileObject expected =
        JavaFileObjects.forSourceString("test/PaperParcelTest", Joiner.on('\n').join(
            ...
            "      new ListAdapter<Integer>(Utils.nullSafeClone(IntegerAdapter.INSTANCE));",
            "  static final TypeAdapter<Map<Integer, Integer>> INTEGER_INTEGER_MAP_ADAPTER = ",
            "      new MapAdapter<Integer, Integer>(",
            "          Utils.nullSafeClone(IntegerAdapter.INSTANCE), ",
            "          Utils.nullSafeClone(IntegerAdapter.INSTANCE));",
            ...
            "      new SetAdapter<Integer>(Utils.nullSafeClone(IntegerAdapter.INSTANCE));",
            "  static final TypeAdapter<SparseArray<Integer>> INTEGER_SPARSE_ARRAY_ADAPTER = ",
            "      new SparseArrayAdapter<Integer>(Utils.nullSafeClone(IntegerAdapter.INSTANCE));",
            "  static final TypeAdapter<Collection<Integer>> INTEGER_COLLECTION_ADAPTER = ",
            "      new CollectionAdapter<Integer>(Utils.nullSafeClone(IntegerAdapter.INSTANCE));",
            "  static final TypeAdapter<ArrayMap<Integer, Boolean>> INTEGER_BOOLEAN_ARRAY_MAP_ADAPTER = ",
            "      new ArrayMapAdapter<Integer, Boolean>(",
            "          Utils.nullSafeClone(IntegerAdapter.INSTANCE), ",
            "          Utils.nullSafeClone(BooleanAdapter.INSTANCE));",
            "  static final TypeAdapter<ArraySet<Integer>> INTEGER_ARRAY_SET_ADAPTER = ",
            "      new ArraySetAdapter<Integer>(Utils.nullSafeClone(IntegerAdapter.INSTANCE));",
            "  static final TypeAdapter<LongSparseArray<Integer>> INTEGER_LONG_SPARSE_ARRAY_ADAPTER = ",
            "      new LongSparseArrayAdapter<Integer>(Utils.nullSafeClone(IntegerAdapter.INSTANCE));",
            "  static final TypeAdapter<TestEnum> TEST_ENUM_ENUM_ADAPTER = new EnumAdapter<TestEnum>();",
            "  @NonNull",
            ...
            "      Boolean ab = Utils.readNullable(in, BooleanAdapter.INSTANCE);",
            "      byte ac = in.readByte();",
            "      Byte ad = Utils.readNullable(in, ByteAdapter.INSTANCE);",
            ...
            "      Character ai = Utils.readNullable(in, CharacterAdapter.INSTANCE);",
            "      double aj = in.readDouble();",
            "      Double ak = Utils.readNullable(in, DoubleAdapter.INSTANCE);",
            "      float al = in.readFloat();",
            "      Float am = Utils.readNullable(in, FloatAdapter.INSTANCE);",
            "      int an = in.readInt();",
            "      Integer ao = Utils.readNullable(in, IntegerAdapter.INSTANCE);",
            "      long ap = in.readLong();",
            "      Long aq = Utils.readNullable(in, LongAdapter.INSTANCE);",
            ...
            "      Short aw = Utils.readNullable(in, ShortAdapter.INSTANCE);",
            "      SizeF ax = Utils.readNullable(in, SizeFAdapter.INSTANCE);",
            "      Size ay = Utils.readNullable(in, SizeAdapter.INSTANCE);",
            ...
            "      short[] bi = Utils.readNullable(in, ShortArrayAdapter.INSTANCE);",
            ...
            "      SparseIntArray bn = Utils.readNullable(in, SparseIntArrayAdapter.INSTANCE);",
            "      SparseLongArray bo = Utils.readNullable(in, SparseLongArrayAdapter.INSTANCE);",
            "      ArrayMap<Integer, Boolean> bp = Utils.readNullable(in, PaperParcelTest.INTEGER_BOOLEAN_ARRAY_MAP_ADAPTER);",
            "      ArraySet<Integer> bq = Utils.readNullable(in, PaperParcelTest.INTEGER_ARRAY_SET_ADAPTER);",
            "      LongSparseArray<Integer> br = Utils.readNullable(in, PaperParcelTest.INTEGER_LONG_SPARSE_ARRAY_ADAPTER);",
            "      TestEnum bs = Utils.readNullable(in, PaperParcelTest.TEST_ENUM_ENUM_ADAPTER);",
            "      Test data = new Test();",
            "      data.aa = aa;",
            "      data.ab = ab;",
            "      data.ac = ac;",
            ...
            "    Utils.writeNullable(data.ab, dest, flags, BooleanAdapter.INSTANCE);",
            "    dest.writeByte(data.ac);",
            "    Utils.writeNullable(data.ad, dest, flags, ByteAdapter.INSTANCE);",
            ...
            "    Utils.writeNullable(data.ai, dest, flags, CharacterAdapter.INSTANCE);",
            "    dest.writeDouble(data.aj);",
            "    Utils.writeNullable(data.ak, dest, flags, DoubleAdapter.INSTANCE);",
            "    dest.writeFloat(data.al);",
            "    Utils.writeNullable(data.am, dest, flags, FloatAdapter.INSTANCE);",
            "    dest.writeInt(data.an);",
            "    Utils.writeNullable(data.ao, dest, flags, IntegerAdapter.INSTANCE);",
            "    dest.writeLong(data.ap);",
            "    Utils.writeNullable(data.aq, dest, flags, LongAdapter.INSTANCE);",
            ...
            "    Utils.writeNullable(data.aw, dest, flags, ShortAdapter.INSTANCE);",
            "    Utils.writeNullable(data.ax, dest, flags, SizeFAdapter.INSTANCE);",
            "    Utils.writeNullable(data.ay, dest, flags, SizeAdapter.INSTANCE);",
            ...
            "    Utils.writeNullable(data.bi, dest, flags, ShortArrayAdapter.INSTANCE);",
            ...
            "    Utils.writeNullable(data.bn, dest, flags, SparseIntArrayAdapter.INSTANCE);",
            "    Utils.writeNullable(data.bo, dest, flags, SparseLongArrayAdapter.INSTANCE);",
            "    Utils.writeNullable(data.bp, dest, flags, PaperParcelTest.INTEGER_BOOLEAN_ARRAY_MAP_ADAPTER);",
            "    Utils.writeNullable(data.bq, dest, flags, PaperParcelTest.INTEGER_ARRAY_SET_ADAPTER);",
            "    Utils.writeNullable(data.br, dest, flags, PaperParcelTest.INTEGER_LONG_SPARSE_ARRAY_ADAPTER);",
            "    Utils.writeNullable(data.bs, dest, flags, PaperParcelTest.TEST_ENUM_ENUM_ADAPTER);",
            "  }",
            "}"
        ));
  ...
  @Test public void complexTypeAdapterTest() {
    ...
    JavaFileObject expected =
        JavaFileObjects.forSourceString("test/PaperParcelTest", Joiner.on('\n').join(
            ...
            GeneratedLines.GENERATED_ANNOTATION,
            "final class PaperParcelTest {",
            "  static final TypeAdapter<Map<List<Integer>[], Map<Integer, Boolean>>> ",
            ...
            "    @Override",
            "    public Test createFromParcel(Parcel in) {",
            "      Map<List<Integer>[], Map<Integer, Boolean>> field1 = ",
  ...
  @Test public void genericArrayTypeAdapterTest() {
    ...
    JavaFileObject expected =
        JavaFileObjects.forSourceString("test/PaperParcelTest", Joiner.on('\n').join(
            ...
            GeneratedLines.GENERATED_ANNOTATION,
            "final class PaperParcelTest {",
            "  static final TypeAdapter<Integer[]> INTEGER_GENERIC_ARRAY_ADAPTER = new GenericArrayAdapter<Integer>();",
            "  @NonNull",
            "  static final Parcelable.Creator<Test> CREATOR = new Parcelable.Creator<Test>() {",
            "    @Override",
            "    public Test createFromParcel(Parcel in) {",
            "      Integer[] field = Utils.readNullable(in, PaperParcelTest.INTEGER_GENERIC_ARRAY_ADAPTER);",
            "      Test data = new Test();",
            "      data.field = field;",
            "      return data;",
            "    }",
            ...
            "  }",
            "  static void writeToParcel(@NonNull Test data, @NonNull Parcel dest, int flags) {",
            "    Utils.writeNullable(data.field, dest, flags, PaperParcelTest.INTEGER_GENERIC_ARRAY_ADAPTER);",
            "  }",
            "}"
        ));
  ...
  @Test public void wildcardAdapterTest() {
    ...
    JavaFileObject expected =
        JavaFileObjects.forSourceString("test/PaperParcelTest", Joiner.on('\n').join(
            ...
            GeneratedLines.GENERATED_ANNOTATION,
            "final class PaperParcelTest {",
            "  static final TypeAdapter<List<? extends Integer>> WILDCARD_ADAPTER = new WildcardAdapter();",
            "  @NonNull",
            "  static final Parcelable.Creator<Test> CREATOR = new Parcelable.Creator<Test>() {",
            "    @Override",
            "    public Test createFromParcel(Parcel in) {",
            "      List<? extends Integer> field = Utils.readNullable(in, PaperParcelTest.WILDCARD_ADAPTER);",
            "      Test data = new Test();",
            "      data.field = field;",
            "      return data;",
            "    }",
            ...
            "  }",
            "  static void writeToParcel(@NonNull Test data, @NonNull Parcel dest, int flags) {",
            "    Utils.writeNullable(data.field, dest, flags, PaperParcelTest.WILDCARD_ADAPTER);",
            "  }",
            "}"
        ));
  ...
  @Test public void genericWildcardAdapterTest() {
    ...
    JavaFileObject expected =
        JavaFileObjects.forSourceString("test/PaperParcelTest", Joiner.on('\n').join(
            ...
            GeneratedLines.GENERATED_ANNOTATION,
            "final class PaperParcelTest {",
            "  static final TypeAdapter<List<? extends Integer>> INTEGER_WILDCARD_ADAPTER = new WildcardAdapter<Integer>();",
            "  @NonNull",
            "  static final Parcelable.Creator<Test> CREATOR = new Parcelable.Creator<Test>() {",
            "    @Override",
            "    public Test createFromParcel(Parcel in) {",
            "      List<? extends Integer> field = Utils.readNullable(in, PaperParcelTest.INTEGER_WILDCARD_ADAPTER);",
            "      Test data = new Test();",
            "      data.field = field;",
            "      return data;",
            "    }",
            ...
            "  }",
            "  static void writeToParcel(@NonNull Test data, @NonNull Parcel dest, int flags) {",
            "    Utils.writeNullable(data.field, dest, flags, PaperParcelTest.INTEGER_WILDCARD_ADAPTER);",
            "  }",
            "}"
        ));
  ...
  @Test public void complexGenericPaperParcelTest() {
    ...
    JavaFileObject expected =
        JavaFileObjects.forSourceString("test/PaperParcelTest", Joiner.on('\n').join(
            ...
            "          PaperParcelTest.PARCELABLE_PARCELABLE_ADAPTER, StringAdapter.INSTANCE);",
            "  @NonNull",
            "  static final Parcelable.Creator<Test> CREATOR = new Parcelable.Creator<Test>() {",
            "    @Override",
            "    public Test createFromParcel(Parcel in) {",
  ...
  @Test public void primitiveArrayAsTypeParameterTest() {
    ...
    JavaFileObject expected =
        JavaFileObjects.forSourceString("test/PaperParcelTest", Joiner.on('\n').join(
            ...
            "      new ListAdapter<int[]>(IntArrayAdapter.INSTANCE);",
            "  @NonNull",
            "  static final Parcelable.Creator<Test> CREATOR = new Parcelable.Creator<Test>() {",
            "    @Override",
            "    public Test createFromParcel(Parcel in) {",
  ...
  @Test public void nonNullFieldTest() {
    ...
    JavaFileObject expected =
        JavaFileObjects.forSourceString("test/PaperParcelTest", Joiner.on('\n').join(
            ...
            "    @Override",
            "    public Test createFromParcel(Parcel in) {",
            "      Integer value1 = IntegerAdapter.INSTANCE.readFromParcel(in);",
            "      Integer value2 = IntegerAdapter.INSTANCE.readFromParcel(in);",
            "      Test data = new Test();",
            "      data.value1 = value1;",
            "      data.value2 = value2;",
            "      return data;",
            ...
            "  }",
            "  static void writeToParcel(@NonNull Test data, @NonNull Parcel dest, int flags) {",
            "    IntegerAdapter.INSTANCE.writeToParcel(data.value1, dest, flags);",
            "    IntegerAdapter.INSTANCE.writeToParcel(data.value2, dest, flags);",
            "  }",
            "}"
        ));
  ...
  @Test public void nullSafeAdapterTest() {
    ...
    JavaFileObject expected =
        JavaFileObjects.forSourceString("test/PaperParcelTest", Joiner.on('\n').join(
            ...
            GeneratedLines.GENERATED_ANNOTATION,
            "final class PaperParcelTest {",
            "  static final TypeAdapter<Integer> MY_TYPE_ADAPTER = new MyTypeAdapter();",
            "  @NonNull",
            "  static final Parcelable.Creator<Test> CREATOR = new Parcelable.Creator<Test>() {",
            "    @Override",
            "    public Test createFromParcel(Parcel in) {",
            "      Integer value = PaperParcelTest.MY_TYPE_ADAPTER.readFromParcel(in);",
            "      Test data = new Test();",
            "      data.value = value;",
            "      return data;",
            "    }",
